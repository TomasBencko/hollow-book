...
- Zobraz text ešte kým sa obrázok načítava. Aj po prvotnom spustení hry, aj po prechode na ďalšie kroky. Máme animáciu pre loading obrázku už hotovú. Hneď po úspešnom story requeste, kým sa čaká na image request.
